...
impl Smbios for SmbiosImpl {
    ...
    fn publish_table(
        ...
        let table_ptr = ConfigTablePtr::from_raw(ep_addr as *mut core::ffi::c_void)
            .ok_or(crate::error::SmbiosError::AllocationFailed)?;
        self.config_table
            .install_table(SMBIOS3_TABLE_GUID, table_ptr)
...
mod tests {
    ...
    fn create_test_smbios_impl_with_publish() -> SmbiosImpl {
        ...
        config_table_mock.expect_install_table().returning(|_, _| Ok(()));
