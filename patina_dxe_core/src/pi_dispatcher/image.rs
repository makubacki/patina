...
const EXPECTED_IMAGE_MACHINE: u16 = 0x8664;
#[cfg(target_arch = "x86")]
const EXPECTED_IMAGE_MACHINE: u16 = 0x14c;
#[cfg(target_arch = "aarch64")]
const EXPECTED_IMAGE_MACHINE: u16 = 0xAA64;
...
mod tests {
    ...
    fn load_image_should_fail_for_arch_mismatch() {
        with_locked_state(|| {
            ...
            #[cfg(target_arch = "x86_64")]
            const MISMATCH_MACHINE: u16 = 0x14c;
            #[cfg(target_arch = "x86")]
            const MISMATCH_MACHINE: u16 = 0x8664;
            #[cfg(target_arch = "aarch64")]
            const MISMATCH_MACHINE: u16 = 0x8664;
