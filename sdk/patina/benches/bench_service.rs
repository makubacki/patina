...
//!
//! `> cargo make bench -p patina --bench bench_service`
//!
//! If you wish to run a subset of benchmarks in this file, you can filter them by name:
//!
//! `> cargo make bench -p patina --bench bench_service -- <filter>`
//!
//! ## Examples
//!
//! ```bash
//! > cargo make bench -p patina --bench bench_service -- dyn
//! > cargo make bench -p patina --bench bench_service -- concrete
//! > cargo make bench -p patina --bench bench_service
//! ```
//!
//! ## License
